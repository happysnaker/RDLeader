...
The latest public packaging slice is a captioned browser walkthrough video built from the public demo proof ladder. Next useful slices are the public demo distribution kit in [RDLeader#20](https://github.com/happysnaker/RDLeader/issues/20), license posture, and broader DevPlan bundle sanitization.
...
Public demo assets: [landing section](docs/public/landing-page.md) · [narrated browser video](docs/public/narrated-walkthrough-video.md) · [demo walkthrough](docs/public/demo-walkthrough.md) · [demo SVG assets](docs/public/demo-assets.md) · [walkthrough video](docs/public/walkthrough-video.md) · [browser walkthrough](docs/public/browser-walkthrough.md) · [demo reset](docs/public/demo-reset.md) · [promo kit](docs/public/promo-kit.md).
