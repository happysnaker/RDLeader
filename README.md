...
The latest public packaging slice is a public landing-page section that turns the proof ladder into reviewer/sponsor copy. Next useful slices are the narrated browser walkthrough video/GIF in [RDLeader#19](https://github.com/happysnaker/RDLeader/issues/19), license posture, and broader DevPlan bundle sanitization.
...
Public demo assets: [landing section](docs/public/landing-page.md) · [demo walkthrough](docs/public/demo-walkthrough.md) · [demo SVG assets](docs/public/demo-assets.md) · [walkthrough video](docs/public/walkthrough-video.md) · [browser walkthrough](docs/public/browser-walkthrough.md) · [demo reset](docs/public/demo-reset.md) · [promo kit](docs/public/promo-kit.md).
