...
Current public milestone: sanitized QA evidence and runtime endurance design notes are published under `docs/public/`; next milestone is fake/demo screenshots or a short public walkthrough video.
