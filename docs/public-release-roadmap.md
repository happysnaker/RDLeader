...
| Employee-agent onboarding guide | Public guide for isolated employee bot homes, secret refs, setup/status commands, and failure modes | [RDLeader#16](https://github.com/happysnaker/RDLeader/issues/16) |
