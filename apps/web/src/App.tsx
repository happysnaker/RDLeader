        ...
        {detail ? (
          <>
            ...
            {selectedDetailTab === 'overview' ? (
              <div className="detail-tab-panel" role="tabpanel" aria-label="总览">
                <section className="panel-card">
                  <h3>工作可观测性</h3>
            ...
            {selectedDetailTab === 'execution' ? (
              <div className="detail-tab-panel" role="tabpanel" aria-label="执行">
                <WorkItemPanel
            ...
            {selectedDetailTab === 'collaboration' ? (
              <div className="detail-tab-panel" role="tabpanel" aria-label="推进">
                <ProjectGroupPanel
                  employeeId={detail.employeeId}
            ...
            {selectedDetailTab === 'growth' ? (
              <div className="detail-tab-panel" role="tabpanel" aria-label="成长">
            ...
            {selectedDetailTab === 'management' ? (
              <div className="detail-tab-panel" role="tabpanel" aria-label="管理">
                <HrPanel
                  employeeId={detail.employeeId}
